# The data parsed from https://ru.wikipedia.org/wiki/Список_столиц_государств
# by script in https://github.com/SaidRem/prs_sites/blob/main/wikipedia/world_capitals/world_caps.py
